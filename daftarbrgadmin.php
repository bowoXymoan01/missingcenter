...
$barang_hilang = query("SELECT * FROM barang_hilang WHERE status='diproses'");
$barang_temuan = query("SELECT * FROM barang_temuan WHERE status='diproses'" );
...
<body>
    ...
    <header>
        ...
        <h1 class="logo">Barang Diproses</h1>
        <nav>
            <ul>
        ...
        <!-- <form action="" method="post">
            <dv class="mb-4">
                ...
                <button class="btn" style="color:white; padding:5px;" type="submit" name="cari" >cari</button>
            </dv>
        </form> -->
    </header>
    <h1>Barang Temuan</h1> <p>( daftar barang inputan dari Admin)</p>
		<table style="padding: 5px; border: 1px solid black;" border="1" cellpadding="20" cellspacing="0" class="table table-bordered table-striped table-hover">
            ...
            <tr>
                ...
                <td>
                    <?= $row["telepon"]; ?><br>
                    <a href="#" onclick="redirWhatsapp(<?= $row['telepon']; ?>)" class="btn" target="_blank">Hubungi</a>
                </td> <!--telepon-->
