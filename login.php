                        ...
                        <form action="login.php" method="post">
                            <div class="row gtr-uniform">
                                <div class="col-5 col-12-xsmall">
                                    <input class="form-control" id="username"  for="username" placeholder="Username" name="username" type="text" required autofocus value="<?php if (isset($_POST['username'])) echo $_POST['username']; ?>"/>
                                </div>
                                <div class="col-5 col-12-xsmall">
